...
linker.cmd: package/cfg/empty_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem4fcfg.cmd\)\"$""\"C:/Workspace/CCS/Plant_Irrigation_System_2/Plant_Irrigation_System_2/.config/xconfig_empty/\1\""' package/cfg/empty_pem4f.xdl > $@
